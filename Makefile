...
INPUT =			"86 41 32 43 46 83 48 64 0 2 80 55 84 56 74 76 61 18 11 39 47 59 50 34 20 70 89 54 19 62 6 75 31 71 38 37 52 82 88 51 4 5 95 17 15 25 63 14 13 81 98 77 66 22 96 24 90 68 8 53 1 94 91 28 45 85 36 93 21 79 10 67 26 97 35 16 99 33 60 57 69 12 29 27 3 87 42 92 65 40 9 23 78 44 72 30 58 73 49 7"
...
run:
		${MAKE} ${NAME}
		${MAKE} ${NAME_CHECKER}
		./${NAME} ${INPUT} | ./${NAME_CHECKER} ${INPUT} > run.log
		@cat run.log

run_debug:
		${MAKE} ${NAME_DEBUG}
		${MAKE} ${NAME_CHECKER_DEBUG}
		./${NAME_DEBUG} ${INPUT} | ./${NAME_CHECKER_DEBUG} ${INPUT} > run.log
		@cat run.log
